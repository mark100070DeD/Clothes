...
echo Bot is running. Log file: logs\bot_log.txt
echo Do not close this window.
%PY% -u bot.py > logs\bot_log.txt 2>&1
pause
exit /b

:nofile
echo No .env file found. Run scripts\edit-env.bat, paste the token, then try again.
pause
