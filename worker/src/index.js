 ...
 *   LISTING_PAGES   живых страниц Пумы за тик, по умолчанию 2. ГЛАВНАЯ РУЧКА
 *                   СКОРОСТИ: 2 -> круг за 15 минут, 1 -> за 30. Поставить 1,
 *                   если Пума начнёт ругаться. Деплой не нужен
